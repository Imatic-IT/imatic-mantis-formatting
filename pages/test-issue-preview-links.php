...
$t_result = [
    'issue' => [
        ...
        'description' => <<<EOD
<a href="https://example.com/path/to/page?foo=1&bar=2&baz=3">Static Example link</a> - https://example.com/path/to/page?foo=1&bar=2&baz=3

<a href="https://httpbin.org/get?user=john&email=test@example.com&debug=true">Httpbin test s viac parametrami</a> - https://httpbin.org/get?user=john&email=test@example.com&debug=true

<a href="https://postman-echo.com/get?id=1203&status=open&priority=high">Postman Echo link</a> - https://postman-echo.com/get?id=1203&status=open&priority=high

<a href="https://example.com/search?q=test+query&lang=sk&sort=desc&page=5">Example so search parametrami</a> - https://example.com/search?q=test+query&lang=sk&sort=desc&page=5

<a href="https://example.com/api/items?category=books&limit=10&offset=30">API-like query link</a> - https://example.com/api/items?category=books&limit=10&offset=30

<a href="https://example.com/shop/cart?item=123&qty=2&coupon=DISCOUNT10">Shopping cart link</a> - https://example.com/shop/cart?item=123&qty=2&coupon=DISCOUNT10

<a href="https://httpbin.org/get?redirect=1&target=https://example.com/profile?id=55&tab=settings">Nested redirect parametre</a> - https://httpbin.org/get?redirect=1&target=https://example.com/profile?id=55&tab=settings
...
EOD,
        ...
        'notes' => [
            [
                ...
                'text' => '@johndoe@example.com  **test BOLD**',
                'view_state' => [
                    'id' => 50,
                    'name' => 'private',
                    'label' => 'soukromý',
        ...
        'history' => [
            ...
            [
                ...
                'old_value' => 10,
                'new_value' => null,
                'message' => 'Záznam sledován: johndoe@example.com',
            ],
            [
                'created_at' => '2025-09-17T14:46:44+02:00',
                'user' => [
...
if ($t_flags['description_show'] && isset($t_issue['description'])) {
    ...
    //	echo '<td class="bug-description" colspan="5">', $t_issue['description'] , '</td>';
    echo '</tr>';
}
